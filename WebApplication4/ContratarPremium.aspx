...
<asp:Content ID="Content2" ContentPlaceHolderID="Conteudo" runat="server">
    <div class="centro-container">
        <img src="images\contratarPremium.png" alt="Plano Premium" />
        <div class="conteudo-box">
            <h1 style="text-decoration: underline #C0C0C0; ">Plano Premium</h1>
            <ul>
                <li>Número ilimitado de funcionários</li>
                <li>Suporte sem custos adicionais</li>
                <li>Sistema de horas extras</li>
                <li>Sistema de horas à descontar</li>
                <li>Canal de comunicação interno</li>
                <li>IA analista de currículos</li>
                <li>Bot de auto-atendimento para Whatsapp</li>
                <li>Controle de entrada e saída</li>
            </ul>
            <h2 style="margin-bottom: 50px">R$ 149,00</h2>
