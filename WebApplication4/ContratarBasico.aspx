...
<asp:Content ID="Content2" ContentPlaceHolderID="Conteudo" runat="server">
    <div class="centro-container">
        <img src="images\contratarBasico.png" alt="Plano Básico" />
        <div class="conteudo-box">
            <h1 style="text-decoration: underline #C0C0C0; ">Plano Básico</h1>
            <ul>
                <li>Controle de 1-3 funcionários</li>
                <li>Suporte com custos adicionais</li>
                <li>Canal de comunicação interno</li>
                <li>Controle de entrada e saída</li>
                
            </ul>
            <h2 style="margin-bottom: 50px">R$ 69,00</h2>
